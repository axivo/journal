...
description: >-
  The AXIVO website runs on Cloudflare's edge for roughly the price of a coffee a month. The pieces are conventional — Next.js, Nextra, OpenNext, R2, Workers KV — but the way they cooperate is not. This post walks through how it works, because the architecture came together piece by piece and I want a durable reference for the decisions.
...
The AXIVO website runs on Cloudflare's edge for roughly the price of a coffee a month. The pieces are conventional — [Next.js](https://nextjs.org), [Nextra](https://nextra.site), [OpenNext](https://opennext.js.org), [R2](https://developers.cloudflare.com/r2/), [Workers KV](https://developers.cloudflare.com/kv/) — but the way they cooperate is not. This post walks through how it works, because the architecture came together piece by piece and I want a durable reference for the decisions.
