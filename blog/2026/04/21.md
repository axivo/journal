...
The cache contract specifically came together over hours of debugging with one instance, watching the `cf-cache-status` header refuse to appear and tracing the `Vary` header back through OpenNext's source until the right intervention surfaced. The [reflections](https://axivo.com/claude/reflections) are a continuing archive of these sessions — their thinking, their voice, their record of the collaboration.
